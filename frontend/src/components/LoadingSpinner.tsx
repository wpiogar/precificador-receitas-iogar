 ...
 * ============================================================================
 * Descrição: Spinner de carregamento baseado no Flowbite Tailwind CSS
 ...
 * Referência: https://flowbite.com/docs/components/spinner/
 * ============================================================================
 */
...
const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ 
  ...
  // Definir tamanho do spinner baseado na prop size
  const sizeClasses = {
    sm: 'w-6 h-6',
    md: 'w-10 h-10',
    lg: 'w-16 h-16'
